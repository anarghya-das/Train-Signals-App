...
This project also has a few dependencies namely a JSON library which is used to parse the JSON responses received by the app, Open Street Map library used to generate the map view of the app and Android support design libraries to bring the material look and feel to the app.
# Usage
